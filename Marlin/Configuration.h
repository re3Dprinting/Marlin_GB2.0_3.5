...
#define STRING_CONFIG_H_AUTHOR "(Finucane, GB2.0 V3.5)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {118.4,118.5,4029.9,1850} // default steps per unit for Ultimaker
